        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    app.get("/store", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                    ...
                    app.get("/get-all", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                        var users;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    users = _a.sent();
                                    res.json({ message: "Usuários recuperados com sucesso!", users: users });
                                    return [2 /*return*/];
                            }
                        });
                    }); });
